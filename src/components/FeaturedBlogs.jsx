      ...
      <div className='w-full max-w-[1200px] mx-auto px-6'>
        ...
        <div className='flex flex-col justify-center items-center text-center p-2 px-6'>
          <div className='slanted-container'>
            <p className='slanted-text font-medium text-xs sm:text-sm text-white bg-blue-500 py-1'>FEATURED BLOGS</p>
          </div>
          <h1 className='font-bold text-xl sm:text-2xl mt-3'>Read Our Latest Blog Posts</h1>
        </div>
        ...
        <div className='flex flex-col w-full justify-center items-center mt-10 mx-auto'>
          ...
          <div className='relative hover:cursor-pointer h-fit w-full overflow-clip mb-4 rounded-xl group'>
            <div className='absolute top-0 m-2 sm:m-4 left-0 z-50'>
              <p className='font-bold text-xs sm:text-sm text-white py-1 px-3 rounded-3xl bg-black/30'>Popular Right Now</p>
            </div>

            <div className='absolute bottom-0 left-0 md:max-w-[450px] m-2 sm:m-4 text-white z-50'>
              <h2 className='font-bold text-base sm:text-lg py-1'>Unveiling the Mysteries of Machu Picchu: A Journey Through Time</h2>
              <p className='text-sm sm:text-base max-w-[200px] sm:max-w-none'>South America, Historical Wonders</p>
            </div>
            {/* Img Overlay Filter */}
            <div className='absolute w-full h-full inset-0 bg-black/30 rounded-xl z-20' />
            <img
