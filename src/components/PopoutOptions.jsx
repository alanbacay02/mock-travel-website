...
const PopoutOptions = (props) => {
  ...
  return (
    <div>
      ...
      <div className={`md:hidden fixed top-0 left-0 right-0 z-50 ${props.showMenu ? 'block' : 'hidden'}`}>
      ...
      <div className={`hidden fixed top-1/4 left-0 right-0 z-50 overflow-hidden ${props.showMenu ? 'md:block' : 'md:hidden'}`}>
        <div ref={menuRef}  className='p-5 w-[90%] max-w-[800px] bg-white mx-auto rounded-xl'>
          <form onSubmit={handleSearch}>
            <div className='w-full flex flex-row items-center gap-2 border-b-2 border-black border-spacing-2 px-1 mb-3'>
